"bundle";
System.register("node_modules/systemjs-plugin-babel/babel-helpers/toConsumableArray.js", [], function (_export, _context) {
  "use strict";
...
!function(t, e) {
  "object" == typeof exports && "object" == typeof module ? module.exports = e() : "function" == typeof define && define.amd ? define("node_modules/redux/dist/redux.min.js", [], e) : "object" == typeof exports ? exports.Redux = e() : t.Redux = e();
}(this, function() {
  return function(t) {
    function e(r) {
      if (n[r])
    ...
    var o = n(2),
        ...
        y = n(3);
    r(y);
    e.createStore = i["default"], e.combineReducers = c["default"], e.bindActionCreators = f["default"], e.applyMiddleware = d["default"], e.compose = p["default"];
  }, function(t, e) {
    "use strict";
    function n() {
    ...
    function r(t) {
      if (!i(t) || s.call(t) != u || o(t))
        return !1;
      var e = c;
      if ("function" == typeof t.constructor && (e = d(t)), null === e)
        return !0;
      var n = e.constructor;
      ...
      return function(t) {
        return function(n, r, o) {
          ...
          return f = e.map(function(t) {
            return t(s);
          }), a = c["default"].apply(void 0, f)(u.dispatch), i({}, u, {dispatch: a});
        };
      };
    }
    ...
    function i(t) {
      Object.keys(t).forEach(function(e) {
        var n = t[e],
            r = n(void 0, {type: c.ActionTypes.INIT});
        if (void 0 === r)
...
System.register('bower_components/redux-store-element/redux-store.ts', ['node_modules/systemjs-plugin-babel/babel-helpers/toConsumableArray.js', 'node_modules/systemjs-plugin-babel/babel-helpers/classCallCheck.js', 'node_modules/systemjs-plugin-babel/babel-helpers/createClass.js', '../../node_modules/redux/dist/redux.min.js'], function (_export, _context) {
    "use strict";

    var _toConsumableArray, _classCallCheck, _createClass, createStore, stores, listenersToAdd, ReduxStoreComponent;

    return {
        setters: [function (_node_modulesSystemjsPluginBabelBabelHelpersToConsumableArrayJs) {
        ...
        }, function (_node_modulesReduxDistReduxMinJs) {
            createStore = _node_modulesReduxDistReduxMinJs.createStore;
        }],
        execute: function () {
            stores = {};
            listenersToAdd = [];

            ReduxStoreComponent = function () {
                ...
                _createClass(ReduxStoreComponent, [{
                    ...
                    value: function subscribe() {
                        ...
                        stores[this.storeName].subscribe(function () {
                            _this.fire('statechange', {
                                state: stores[_this.storeName].getState()
                            }, {
                                bubbles: false
                            });
                        });
                    ...
                    key: 'storeNameSet',
                    value: function storeNameSet(newValue, oldValue) {
                        if (this.rootReducer && this.storeName) {
                            this.createTheStore();
                        }
                    }
